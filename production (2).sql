...
--
-- Хост: localhost
-- Время создания: Янв 30 2021 г., 22:23
...
INSERT INTO `model` (`ID_Model`, `BarCode`, `Name`, `ID_Subtype`, `ImgPath`) VALUES
...
(5, 235735673734, 'KAG 93AI30R', 4, NULL),
(6, 235263463456, 'F27FG-T10001', 3, NULL),
(8, 234516473476457, 'WW-1001', 4, NULL),
(9, 324, 'MN-100', 4, NULL);
...
--
ALTER TABLE `model`
  MODIFY `ID_Model` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `subtype`
  MODIFY `ID_Subtype` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `type`
--
ALTER TABLE `type`
  MODIFY `ID_Type` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
