...
--
-- Хост: localhost
-- Время создания: Фев 12 2021 г., 17:52
...
(14, 'Керамический электрический 2л.', 'briefly', 1),
(15, 'Керамический электрический 1,7л.', 'briefly', 2),
(16, 'Керамический электрический 1,8л.', 'briefly', 3),
(17, 'Керамический электрический 2л.', 'briefly', 4),
(18, 'Водяной, керамическая подошва, вертикальное отпаривание', 'briefly', 5),
(14, 'Белый', 'Цвет', 6),
(14, '2000 Вт', 'Мощность', 7),
(53, 'Без заморочки', 'briefly', 8),
(54, 'Пустое описание', 'briefly', 9);
...
(14, 4680353001204, 'CT-0061', 16, 19, ''),
...
(53, 1111, 'NN-101', 22, 30, '../img/Кронштейн/NN-101.jpg'),
(54, 43252644, 'UU', 22, 20, '../img/Кронштейн/UU.jpg');
...
--
ALTER TABLE `characteristics`
  MODIFY `ID_Characteristic` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `type`
  MODIFY `ID_Type` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
