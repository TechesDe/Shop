...
--
-- Хост: localhost
-- Время создания: Фев 16 2021 г., 08:52
...
(54, '../img/Чайник/9120099331012-1.jpg', 1);
...
--
ALTER TABLE `characteristics`
  MODIFY `ID_Characteristic` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT для таблицы `images`
--
ALTER TABLE `images`
  MODIFY `number` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `model`
  MODIFY `ID_model` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
